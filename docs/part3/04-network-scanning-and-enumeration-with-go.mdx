...
**How does today's scanning tie into the "assessment" step Chapter 4.6 covers?**
Scanning and enumeration answer "what's reachable and what's running there," which produces raw data like "port 21 open, running vsftpd 2.3.4" — but that data isn't a finding on its own. Chapter 4.6 picks up exactly where this chapter stops, showing how to check that version against known weaknesses and decide whether it's actually a problem worth acting on.
