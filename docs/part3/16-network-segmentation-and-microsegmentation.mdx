...
func main() {
	attempts := []struct{ Source, Destination string }{
		{"web-frontend", "orders-db"},      // should be denied: no direct path
...
[Previous: Zero Trust Networking Concepts](15-zero-trust-networking-concepts.md) | [Next: IDS/IPS: Concepts and Go Implementations](17-ids-ips-concepts-and-go-implementations.md)
