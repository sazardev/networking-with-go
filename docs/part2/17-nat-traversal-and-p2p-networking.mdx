...
[Exercise: Rendezvous Server](../../exercises/part2/17-rendezvous-server/main.go)
...
**Why does the peer program reuse one socket for both the rendezvous exchange and the punch traffic?**
