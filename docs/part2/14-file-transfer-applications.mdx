...
[Exercise: TCP File Transfer Server](../../exercises/part2/14-tcp-file-transfer-server/main.go)
...
[Exercise: TCP File Transfer Client](../../exercises/part2/14-tcp-file-transfer-client/main.go)
