...
func recommendFriends(ctx context.Context, driver neo4j.DriverWithContext, userID string) ([]string, error) {
...
```go
func listProducts(ctx context.Context, afterID string, limit int64) ([]Product, error) {
	filter := bson.M{}
	if afterID != "" {
