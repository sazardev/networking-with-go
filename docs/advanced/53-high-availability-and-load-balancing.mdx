...
func NewLoadBalancer(rawURLs []string) (*LoadBalancer, error) {
	...
	for _, raw := range rawURLs {
		...
		b.healthy.Store(true) // assume healthy until the checker says otherwise
