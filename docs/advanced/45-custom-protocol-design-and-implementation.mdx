...
func ReadMessage(r io.Reader) (*Message, error) {
	...
	const maxPayload = 16 * 1024 * 1024 // refuse to allocate unbounded memory for a hostile length
...
func WriteMessage(w io.Writer, msgType uint8, payload []byte) error {
	header := Header{Version: Version1, Type: msgType, Length: uint32(len(payload))}
